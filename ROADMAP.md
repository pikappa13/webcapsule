...
- [x] `cli.py` — `save`, `search`, `list`, `export` via Typer + Rich
...
- [ ] `webcapsule rebuild-index` command to re-index from scratch
...
- [ ] Full-body text indexing (currently only title + description + tags)
